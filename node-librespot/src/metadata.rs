...
use librespot::core::spotify_id::{FileId, SpotifyAudioType, SpotifyId, SpotifyIdError};
use librespot::protocol as protocol;
pub use librespot::protocol::metadata::AudioFile_Format as FileFormat;
...
pub trait Metadata: Send + Sized + 'static {
    ...
    async fn get(session: &Session, id: SpotifyId) -> Result<Self, MercuryError> {
        match Self::request_url(id) {
            ...
            Ok(uri) => {
                info!("This is the uri being requested via mercury {}", uri);
