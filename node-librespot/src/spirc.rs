...
use librespot::core::mercury::{MercuryError, MercurySender};
use librespot::core::session::Session;
use librespot::core::spotify_id::{SpotifyAudioType, SpotifyId, SpotifyIdError};
use librespot::core::util::SeqGenerator;
use librespot::core::version;
use librespot::playback::mixer::Mixer;
use crate::player::{Player, PlayerEvent, PlayerEventChannel}; // Custom player
use librespot::protocol;
use librespot::protocol::spirc::{DeviceState, Frame, MessageType, PlayStatus, State, TrackRef};
...
impl SpircTask {
    ...
    fn handle_player_event(&mut self, event: PlayerEvent) {
        ...
        // mess with it.
        //
        // Unless a volume event, to help sync with roon before playback
